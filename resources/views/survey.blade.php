                ...
                <div class="flex items-center gap-2.5">
                    ...
                    <div>
                        <div class="flex items-center gap-2">
                            ...
                            <span class="px-1.5 py-0.5 bg-purple-50 text-purple-700 text-[8px] font-black uppercase tracking-wider rounded border border-purple-100">Feedback Required</span>
                        </div>

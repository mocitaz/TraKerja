...
<head>
    ...
    <title>Selamat Tahun Baru Islam 1448 H</title>
</head>
            ...
            <td align="center" style="padding:40px 16px;">
                <table role="presentation" style="width:100%; max-width:600px; border-collapse:collapse;">
                    ...
                    @include('emails.partials.header', [
                        ...
                        'subtitle' => 'Hijrah Menuju Kebaikan dan Keberkahan'
                    ])
                    ...
                    <tr>
                        <td style="background-color:#ffffff; padding:40px 40px 32px 40px; border-left:1px solid #e4e4e7; border-right:1px solid #e4e4e7;">
                            ...
                            <p style="margin:0 0 20px 0; font-size:15px; line-height:26px; color:#3f3f46;">
                                Segenap tim TraKerja mengucapkan Selamat Tahun Baru Islam 1 Muharram 1448 H.
                            </p>

                            <p style="margin:0 0 20px 0; font-size:15px; line-height:26px; color:#3f3f46;">
                                Mari jadikan momentum pergantian tahun ini sebagai titik awal untuk berhijrah, memperbaiki diri, dan meningkatkan kualitas hidup serta profesionalitas kita di masa depan.
                            </p>
                            
                            <p style="margin:0 0 32px 0; font-size:15px; line-height:26px; color:#3f3f46;">
                                Semoga tahun ini membawa kesuksesan dan keberkahan berlimpah bagi Anda.
                            </p>

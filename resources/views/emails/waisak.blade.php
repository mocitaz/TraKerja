...
<head>
    ...
    <title>Selamat Hari Raya Tri Suci Waisak 2570 BE</title>
</head>
            ...
            <td align="center" style="padding:40px 16px;">
                <table role="presentation" style="width:100%; max-width:600px; border-collapse:collapse;">
                    ...
                    @include('emails.partials.header', [
                        ...
                        'subtitle' => 'Berdamai dengan Diri Sendiri, Berdamai dengan Semesta'
                    ])
                    ...
                    <tr>
                        <td style="background-color:#ffffff; padding:40px 40px 32px 40px; border-left:1px solid #e4e4e7; border-right:1px solid #e4e4e7;">
                            ...
                            <p style="margin:0 0 20px 0; font-size:15px; line-height:26px; color:#3f3f46;">
                                Segenap tim TraKerja mengucapkan Selamat Hari Raya Tri Suci Waisak 2570 BE.
                            </p>

                            <p style="margin:0 0 20px 0; font-size:15px; line-height:26px; color:#3f3f46;">
                                Semoga cahaya Waisak membawa pencerahan, kedamaian, dan kebahagiaan bagi kita semua. Mari merenungkan ajaran kasih sayang, kebijaksanaan, dan toleransi antar sesama untuk kehidupan yang lebih harmonis.
                            </p>

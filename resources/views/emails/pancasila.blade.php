...
<head>
    ...
    <title>Selamat Hari Lahir Pancasila</title>
</head>
            ...
            <td align="center" style="padding:40px 16px;">
                <table role="presentation" style="width:100%; max-width:600px; border-collapse:collapse;">
                    ...
                    @include('emails.partials.header', [
                        ...
                        'subtitle' => 'Jiwa Pemersatu Bangsa Menuju Indonesia Maju'
                    ])
                    ...
                    <tr>
                        <td style="background-color:#ffffff; padding:40px 40px 32px 40px; border-left:1px solid #e4e4e7; border-right:1px solid #e4e4e7;">
                            ...
                            <p style="margin:0 0 20px 0; font-size:15px; line-height:26px; color:#3f3f46;">
                                Segenap tim TraKerja mengucapkan Selamat memperingati Hari Lahir Pancasila.
                            </p>

                            <p style="margin:0 0 20px 0; font-size:15px; line-height:26px; color:#3f3f46;">
                                Mari kita senantiasa mengamalkan nilai-nilai luhur Pancasila dalam kehidupan berbangsa dan bernegara. Jadikan keberagaman sebagai kekuatan untuk bersatu, bergotong-royong, dan bersama-sama membangun karya terbaik bagi kemajuan bangsa.
                            </p>

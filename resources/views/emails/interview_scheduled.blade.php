...
<head>
    ...
    <title>Konfirmasi Jadwal Wawancara — TraKerja</title>
</head>
            ...
            <td align="center" style="padding:40px 16px;">
                <table role="presentation" style="width:100%; max-width:600px; border-collapse:collapse;">
                    ...
                    @include('emails.partials.header', [
                        ...
                        'subtitle' => 'Jadwal wawancara Anda telah berhasil dicatat'
                    ])
                    ...
                    <tr>
                        <td style="background-color:#ffffff; padding:40px 40px 32px 40px; border-left:1px solid #e4e4e7; border-right:1px solid #e4e4e7;">
                            ...
                            <p style="margin:0 0 20px 0; font-size:15px; line-height:26px; color:#3f3f46;">
                                Kami ingin mengonfirmasi bahwa jadwal wawancara Anda telah berhasil ditambahkan/diperbarui di sistem TraKerja. Berikut adalah rincian lengkapnya:
                            </p>
                                ...
                                <tr>
                                    <td style="border-top:1px solid #e4e4e7; padding-top:24px;">
                                                    ...
                                                    <table role="presentation" style="width:100%; border-collapse:collapse;">
                                                        ...
                                                        <tr>
                                                            <td style="padding:10px 0; {{ $jobApplication->interview_notes ? 'border-bottom:1px solid #ede9fe;' : '' }}">
                                                                <p style="margin:0 0 3px 0; font-size:11px; font-weight:700; color:#6d28d9; text-transform:uppercase; letter-spacing:0.08em;">Lokasi / Tautan</p>
                                                        ...
                                                        <tr>
                                                            <td style="padding-top:10px;">
                                                                <p style="margin:0 0 3px 0; font-size:11px; font-weight:700; color:#6d28d9; text-transform:uppercase; letter-spacing:0.08em;">Catatan Tambahan</p>
                                        ...
                                        <table role="presentation" style="width:100%; border-collapse:collapse;">
                                            ...
                                            <tr>
                                                <td style="padding:14px 0; border-bottom:1px solid #f4f4f5;">
                                                    <p style="margin:0 0 4px 0; font-size:14px; font-weight:600; color:#18181b;">Siapkan Dokumen Pendukung</p>
                                                    <p style="margin:0; font-size:13px; line-height:21px; color:#71717a;">Pastikan CV terbaru, portofolio, dan dokumen pendukung lainnya sudah siap diakses.</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding:14px 0;">
                                                    <p style="margin:0 0 4px 0; font-size:14px; font-weight:600; color:#18181b;">Lakukan Konfirmasi Kehadiran</p>
                                                    <p style="margin:0; font-size:13px; line-height:21px; color:#71717a;">Jika wawancara dilakukan secara online, pastikan Anda membalas undangan email rekruter sebagai konfirmasi kehadiran.</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <table role="presentation" style="width:100%; border-collapse:collapse; margin-bottom:36px;">
                                <tr>
                                    <td>
                                        <a href="{{ config('app.url') }}/interviews"

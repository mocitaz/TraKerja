...
<tr>
    <td style="padding:24px 28px 20px; background:#fbfaff; border-top:1px solid #f0eaff;">
                                    ...
                                    <tr>
                                        <td style="padding-bottom:12px;">
                                            <div style="display:flex; align-items:center; margin-bottom:8px;">
                                                <div style="display:inline-block; padding:6px; border-radius:8px; background:#ffffff; box-shadow:0 2px 6px rgba(107,70,193,0.10); border:1px solid #ece7ff; margin-right:8px;">
                                                    <img src="{{ asset('images/icon.png') }}" alt="TraKerja" width="24" height="24" style="display:block;">
                                                </div>
                                                <div>
                                                    <h3 style="margin:0; font-size:16px; font-weight:700; color:#1f2937;">TraKerja</h3>
                                                    <p style="margin:0; font-size:11px; color:#6b7280;">Professional Job Application Management</p>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                    ...
                    <table role="presentation" style="width:100%; border-collapse:collapse;">
                            ...
                            <td style="width:50%; text-align:right; vertical-align:top;">
                                <div style="display:inline-flex; align-items:center; gap:12px;">
                                    <a href="https://instagram.com/teknalogi.id" style="display:inline-flex; align-items:center; text-decoration:none;">
                                        <div style="width:20px; height:20px; background:#f3f4f6; border-radius:4px; display:flex; align-items:center; justify-content:center;">
                                            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#6b7280" stroke-width="2">
                                                <rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect>
                                                <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path>
                                                <line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line>
                        ...
                        <tr>
                            <td colspan="2" style="padding-top:8px; text-align:center;">
                                <p style="margin:0; font-size:11px; color:#9ca3af;">© {{ date('Y') }} TraKerja. All rights reserved.</p>
                            </td>
                        </tr>
                    </table>
                </td>

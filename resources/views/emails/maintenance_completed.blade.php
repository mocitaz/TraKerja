...
<head>
    ...
    <title>Sistem TraKerja Siap Digunakan</title>
</head>
            ...
            <td align="center" style="padding:40px 16px;">
                <table role="presentation" style="width:100%; max-width:600px; border-collapse:collapse;">
                    ...
                    @include('emails.partials.header', [
                        'title'    => 'Sistem TraKerja Siap Digunakan',
                        'subtitle' => 'Pemeliharaan Sistem Telah Selesai'
                    ])
                    ...
                    <tr>
                        <td style="background-color:#ffffff; padding:40px 40px 32px 40px; border-left:1px solid #e4e4e7; border-right:1px solid #e4e4e7;">
                            ...
                            <p style="margin:0 0 20px 0; font-size:15px; line-height:26px; color:#3f3f46;">
                                Kami ingin menginformasikan bahwa proses pemeliharaan (<em>maintenance</em>) sistem TraKerja telah selesai dilakukan. Saat ini, seluruh layanan di platform TraKerja sudah dapat diakses dan digunakan kembali dengan normal.
                            </p>

                            <p style="margin:0 0 20px 0; font-size:15px; line-height:26px; color:#3f3f46;">
                                Kami memohon maaf atas ketidaknyamanan dan waktu tunggu Anda selama proses pemeliharaan berlangsung. Peningkatan ini kami lakukan secara rutin untuk memastikan performa yang optimal dan kenyamanan Anda dalam menggunakan layanan kami.
                            </p>
                            
                            <p style="margin:0 0 32px 0; font-size:15px; line-height:26px; color:#3f3f46;">
                                Terima kasih atas pengertian dan kesabaran Anda. Selamat kembali menggunakan TraKerja!
                            </p>

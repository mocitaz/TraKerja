...
<head>
    ...
    <title>Selamat Memperingati Maulid Nabi Muhammad SAW</title>
</head>
            ...
            <td align="center" style="padding:40px 16px;">
                <table role="presentation" style="width:100%; max-width:600px; border-collapse:collapse;">
                    ...
                    @include('emails.partials.header', [
                        ...
                        'subtitle' => 'Meneladani Akhlak Mulia Sang Rasul'
                    ])
                    ...
                    <tr>
                        <td style="background-color:#ffffff; padding:40px 40px 32px 40px; border-left:1px solid #e4e4e7; border-right:1px solid #e4e4e7;">
                            ...
                            <p style="margin:0 0 20px 0; font-size:15px; line-height:26px; color:#3f3f46;">
                                Segenap tim TraKerja mengucapkan Selamat Memperingati Maulid Nabi Muhammad SAW.
                            </p>

                            <p style="margin:0 0 20px 0; font-size:15px; line-height:26px; color:#3f3f46;">
                                Semoga di hari yang mulia ini, kita dapat merenungkan dan menjadikan keteladanan akhlak beliau sebagai inspirasi dalam bekerja, berbuat baik, dan bermanfaat bagi sesama.
                            </p>
                            
                            <p style="margin:0 0 32px 0; font-size:15px; line-height:26px; color:#3f3f46;">
                                Semoga keberkahan dan kedamaian senantiasa menyertai kita semua.
                            </p>

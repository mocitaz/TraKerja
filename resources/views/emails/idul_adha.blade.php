...
<head>
    ...
    <title>Selamat Hari Raya Idul Adha 1447 H</title>
</head>
            ...
            <td align="center" style="padding:40px 16px;">
                <table role="presentation" style="width:100%; max-width:600px; border-collapse:collapse;">
                    ...
                    @include('emails.partials.header', [
                        ...
                        'subtitle' => 'Menebar Kebaikan dan Keikhlasan di Hari yang Suci'
                    ])
                    ...
                    <tr>
                        <td style="background-color:#ffffff; padding:40px 40px 32px 40px; border-left:1px solid #e4e4e7; border-right:1px solid #e4e4e7;">
                            ...
                            <p style="margin:0 0 20px 0; font-size:15px; line-height:26px; color:#3f3f46;">
                                Segenap tim TraKerja mengucapkan Selamat Hari Raya Idul Adha 1447 H.
                            </p>

                            <p style="margin:0 0 20px 0; font-size:15px; line-height:26px; color:#3f3f46;">
                                Semoga semangat berkurban senantiasa menumbuhkan keikhlasan dan rasa peduli terhadap sesama di hati kita semua. Semoga hari raya ini membawa kedamaian, kesehatan, serta keberkahan bagi kamu dan keluarga tercinta.
                            </p>

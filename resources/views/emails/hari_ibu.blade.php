...
<head>
    ...
    <title>Selamat Hari Ibu Nasional</title>
</head>
            ...
            <td align="center" style="padding:40px 16px;">
                <table role="presentation" style="width:100%; max-width:600px; border-collapse:collapse;">
                    ...
                    @include('emails.partials.header', [
                        'title'    => 'Selamat Hari Ibu Nasional',
                        'subtitle' => 'Perempuan Berdaya, Indonesia Maju'
                    ])
                    ...
                    <tr>
                        <td style="background-color:#ffffff; padding:40px 40px 32px 40px; border-left:1px solid #e4e4e7; border-right:1px solid #e4e4e7;">
                            ...
                            <p style="margin:0 0 20px 0; font-size:15px; line-height:26px; color:#3f3f46;">
                                Segenap tim TraKerja mengucapkan Selamat Hari Ibu Nasional.
                            </p>

                            <p style="margin:0 0 20px 0; font-size:15px; line-height:26px; color:#3f3f46;">
                                Hari ini kita merayakan peran luar biasa, cinta tanpa batas, dan kekuatan para ibu serta perempuan Indonesia. Mari kita jadikan momentum ini untuk terus mendukung peran perempuan dalam keluarga maupun dunia profesional.
                            </p>
                            
                            <p style="margin:0 0 32px 0; font-size:15px; line-height:26px; color:#3f3f46;">
                                Terima kasih atas segala cinta dan dedikasimu, Ibu!
                            </p>

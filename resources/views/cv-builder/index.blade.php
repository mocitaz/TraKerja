                    ...
                    <div>
                        <h2 class="text-lg sm:text-2xl font-bold bg-gradient-to-r from-[#d983e4] to-[#4e71c5] bg-clip-text text-transparent">
                            ...
                            @if(auth()->user() && auth()->user()->is_premium && auth()->user()->payment_status === 'paid')
                                <span class="ml-1 sm:ml-2 px-1.5 sm:px-2 py-0.5 sm:py-1 text-xs bg-yellow-100 text-yellow-800 rounded-full">PREMIUM</span>
                            @endif
                        </h2>
                        <p class="text-xs text-gray-500 mt-0.5 hidden sm:block">Build your professional CV</p>
                    </div>
                </div>
            </div>

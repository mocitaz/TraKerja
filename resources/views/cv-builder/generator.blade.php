<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <!-- Back Button -->
            <div class="mb-6">
                <a href="{{ route('cv.builder') }}" class="inline-flex items-center gap-2 px-4 py-2 text-sm text-gray-600 hover:text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
            ...
            <div class="bg-white border border-gray-200 rounded-lg p-4 mb-6 shadow-sm">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h4 class="font-semibold text-gray-900 text-sm">All Templates Available</h4>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200">
                <div class="px-6 py-4 border-b border-gray-200">
                    ...
                    <p class="text-sm text-gray-600 mt-1">Choose from our professional CV templates</p>
                </div>
                <div class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div class="border border-gray-200 rounded-lg overflow-hidden hover:shadow-md transition-shadow duration-200">
                        <div class="p-4 border-b border-gray-200">
                            <div class="flex items-center justify-between mb-2">
                                <h4 class="font-semibold text-gray-900">Minimal</h4>
                                <span class="px-2 py-1 bg-green-100 text-green-800 text-xs rounded-full font-medium">Free</span>
                            </div>
                            <p class="text-sm text-gray-600">Clean, ATS-friendly design</p>
                        </div>
                        <div class="p-4 bg-gray-50 h-32 flex items-center justify-center">
                        ...
                        <div class="p-4 bg-white">
                            <form method="POST" action="{{ route('cv-builder.preview') }}" target="_blank" class="w-full">
                                ...
                                <button type="submit"
                                    class="w-full bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg font-medium transition-colors duration-200 flex items-center justify-center gap-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="border border-gray-200 rounded-lg overflow-hidden hover:shadow-md transition-shadow duration-200">
                        <div class="p-4 border-b border-gray-200">
                            <div class="flex items-center justify-between mb-2">
                                <h4 class="font-semibold text-gray-900">Professional</h4>
                                <span class="px-2 py-1 bg-green-100 text-green-800 text-xs rounded-full font-medium">Free</span>
                            </div>
                            <p class="text-sm text-gray-600">Modern, corporate design</p>
                        </div>
                        <div class="p-4 bg-gray-50 h-32 flex items-center justify-center">
                            <div class="text-center text-gray-400">
                                <svg class="w-12 h-12 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="border border-gray-200 rounded-lg overflow-hidden hover:shadow-md transition-shadow duration-200">
                        <div class="p-4 border-b border-gray-200">
                            <div class="flex items-center justify-between mb-2">
                                <h4 class="font-semibold text-gray-900">Creative</h4>
                                <span class="px-2 py-1 bg-green-100 text-green-800 text-xs rounded-full font-medium">Free</span>
                            </div>
                    ...
                    <div class="border border-gray-200 rounded-lg overflow-hidden hover:shadow-md transition-shadow duration-200">
                        <div class="p-4 border-b border-gray-200">
                            <div class="flex items-center justify-between mb-2">
                                <h4 class="font-semibold text-gray-900">Elegant</h4>
                                <span class="px-2 py-1 bg-green-100 text-green-800 text-xs rounded-full font-medium">Free</span>
                            </div>
                            <p class="text-sm text-gray-600">Sophisticated two-column layout</p>
                        </div>
                        <div class="p-4 bg-gray-50 h-32 flex items-center justify-center">
                            <div class="text-center text-gray-400">
                                <svg class="w-12 h-12 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">

...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
    ...
    <div class="relative bg-gradient-to-r from-[#d983e4] via-[#c775d8] to-[#4e71c5] rounded-xl shadow-lg overflow-hidden mb-5">
        <div class="relative p-4 sm:p-5">
            <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                <div class="flex items-start sm:items-center space-x-3 flex-1 min-w-0">
                    <!-- Company Icon -->
                    <div class="w-12 h-12 sm:w-13 sm:h-13 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center shadow-lg ring-2 ring-white/30 flex-shrink-0">
                        <svg class="w-6 h-6 sm:w-7 sm:h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                        </svg>
                    </div>
                    <div class="flex-1 min-w-0">
                        <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold text-white mb-1 truncate">{{ $job->position }}</h1>
                ...
                <a href="{{ $job->platform_link }}" target="_blank" 
                   class="inline-flex items-center justify-center px-4 py-2 bg-white text-[#4e71c5] rounded-lg font-semibold hover:bg-white/95 transition-all duration-200 shadow text-sm w-full sm:w-auto">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-5">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 hover:shadow-md transition-shadow duration-200">
            <div class="flex items-center gap-2 mb-2">
                ...
                <p class="text-xs font-medium text-gray-500">Stage</p>
            </div>
    ...
    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl shadow-sm border border-blue-200 p-4 mb-5">
        <div class="flex items-start justify-between gap-4">
            <div class="flex items-start gap-3 flex-1">
                <div class="w-10 h-10 bg-blue-500 rounded-xl flex items-center justify-center flex-shrink-0 shadow">
                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                    </svg>
                </div>
                <div class="flex-1 min-w-0">
                    <h3 class="text-base font-bold text-gray-900 mb-2">Interview Scheduled</h3>
            ...
            <div class="text-right flex-shrink-0">
                ...
                <p class="text-lg font-bold text-blue-600">{{ $job->interview_date->diffForHumans(null, true) }}</p>
            </div>
            @endif
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 mb-5">
        ...
        <div class="lg:col-span-2 space-y-4">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5 hover:shadow-md transition-shadow duration-200">
                ...
                <p class="text-base font-bold text-gray-900">{{ $job->location }}</p>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5 hover:shadow-md transition-shadow duration-200">
                ...
                <p class="text-base font-bold text-gray-900 mb-3">{{ $job->platform }}</p>
                @if($job->platform_link)
                <a href="{{ $job->platform_link }}" target="_blank" 
                   class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors duration-200 text-sm font-medium shadow-sm">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
        <div class="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-8 text-sm text-gray-600">

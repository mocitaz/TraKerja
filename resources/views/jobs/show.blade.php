...
<div class="max-w-5xl mx-auto px-4 py-6 relative z-10">
    ...
    <div class="relative overflow-hidden bg-gradient-to-br from-[#d983e4] via-[#c473d1] to-[#4e71c5] shadow-2xl rounded-2xl p-5 mb-6 hover:shadow-3xl transition-all duration-500 group">
        <!-- Animated background elements -->
        <div class="absolute inset-0 overflow-hidden">
            <div class="absolute -top-20 -right-20 w-40 h-40 bg-gradient-to-br from-pink-400/30 to-primary-400/30 rounded-full blur-2xl animate-pulse"></div>
            ...
            <div class="absolute bottom-0 right-1/3 w-24 h-24 bg-gradient-to-br from-indigo-400/20 to-primary-400/20 rounded-full blur-lg animate-pulse" style="animation-delay: 2s;"></div>
        ...
        <div class="relative z-10 text-left">
            ...
            <div class="flex items-center">
                ...
                <p class="text-lg text-primary-100 drop-shadow-md">{{ $job->company_name }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 gap-6">
        <div class="space-y-6">
            ...
            <div class="bg-white/80 backdrop-blur-sm border border-white/20 shadow-xl rounded-3xl p-8 hover:shadow-2xl transition-all duration-300 relative overflow-hidden">
                ...
                <div class="absolute inset-0 bg-gradient-to-br from-primary-50/30 to-blue-50/30 opacity-50"></div>
                <div class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-primary-100/20 to-transparent rounded-full -translate-y-16 translate-x-16"></div>
                <div class="relative z-10">
                @php
                    $statusColor = [
                        'On Process' => '#a570f0', // primary-500
                        'Declined' => '#dc2626',   // red-600
                        'Accepted' => '#10b981',   // emerald-500
                    ][$job->application_status ?? 'On Process'] ?? '#2563eb';
                    $stageColor = [
                        'Applied' => '#a570f0',          // primary-500
                        'Follow Up' => '#0ea5e9',        // sky-600
                        'Assessment Test' => '#7c3aed',  // violet-600
                        'Psychotest' => '#a570f0',       // primary-500
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="group">
                        ...
                        <div class="w-8 h-8 bg-gradient-to-br from-primary-100 to-primary-200 rounded-lg flex items-center justify-center mr-3 group-hover:scale-110 transition-transform duration-200">
                        ...
                        <p class="text-lg font-bold text-gray-900 group-hover:text-primary-700 transition-colors duration-200">{{ $job->location }}</p>
                    </div>
                    <div class="group">
                        <div class="flex items-center mb-2">
                        <div class="w-8 h-8 bg-gradient-to-br from-primary-100 to-primary-200 rounded-lg flex items-center justify-center mr-3 group-hover:scale-110 transition-transform duration-200">
                        ...
                        <p class="text-lg font-bold text-gray-900 group-hover:text-primary-700 transition-colors duration-200">{{ $job->platform }}</p>
                    </div>
                    <div class="group">
                        <div class="flex items-center mb-2">
                        <div class="w-8 h-8 bg-gradient-to-br from-primary-100 to-primary-200 rounded-lg flex items-center justify-center mr-3 group-hover:scale-110 transition-transform duration-200">
                    ...
                    <div class="group">
                        ...
                        <p class="text-lg font-bold text-gray-900 group-hover:text-primary-700 transition-colors duration-200">{{ $job->career_level ?? '-' }}</p>
                    </div>
                    <div class="group">
                        <div class="flex items-center mb-2">
                        <div class="w-8 h-8 bg-gradient-to-br from-primary-100 to-primary-200 rounded-lg flex items-center justify-center mr-3 group-hover:scale-110 transition-transform duration-200">
                        ...
                        <p class="text-lg font-bold text-gray-900 group-hover:text-primary-700 transition-colors duration-200">{{ optional($job->application_date)->format('Y-m-d') }}</p>
                    </div>
                </div>
                </div>
            </div>
            ...
            <div class="bg-white/80 backdrop-blur-sm border border-white/20 shadow-xl rounded-3xl p-8 hover:shadow-2xl transition-all duration-300 relative overflow-hidden">
                <!-- Subtle background pattern -->
                <div class="absolute inset-0 bg-gradient-to-br from-blue-50/30 to-primary-50/30 opacity-50"></div>
                ...
                <div class="relative z-10">
                    ...
                    @if($job->platform_link)
                        <a href="{{ $job->platform_link }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-primary-600 to-primary-700 text-white rounded-xl hover:from-primary-700 hover:to-primary-800 transition-all duration-200 shadow-sm hover:shadow-md">

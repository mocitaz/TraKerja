            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                ...
                <div class="relative bg-white border-2 border-[#d983e4] rounded-3xl p-8 shadow-2xl shadow-[#d983e4]/20 animate-float-slow z-10">
                    ...
                    <div class="border-t border-gray-100 pt-6 space-y-4 mb-8">
                        ...
                        <div class="flex items-start gap-3 text-sm text-gray-600"><svg class="w-5 h-5 text-green-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> 1 kredit Cover Letter Generator</div>
                    </div>
                    <a href="mailto:trakerja@teknalogi.id?subject=TraKerja Premium Pro" class="block w-full text-center px-6 py-4 bg-gradient-to-r from-[#d983e4] to-[#4e71c5] text-white rounded-xl font-bold hover:shadow-lg hover:scale-[1.02] transition-all duration-300">
                        Beli Sekarang
                    </a>
                </div>
                ...
                <div class="relative bg-white border border-gray-100 rounded-3xl p-8 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group mt-4 md:mt-0">
                    ...
                    <div class="border-t border-gray-100 pt-6 space-y-4 mb-8">
                        ...
                        <div class="flex items-start gap-3 text-sm text-gray-600"><svg class="w-5 h-5 text-[#4e71c5] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg> +10 kredit Cover Letter</div>
                    ...
                    <a href="mailto:trakerja@teknalogi.id?subject=TraKerja AI Add-On" class="block w-full text-center px-6 py-3.5 bg-white border-2 border-[#4e71c5] text-[#4e71c5] rounded-xl font-bold hover:bg-[#4e71c5] hover:text-white transition-all duration-300">
                        Top-Up Sekarang
                    </a>
                </div>

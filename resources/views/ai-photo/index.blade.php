                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                    <div class="group/field space-y-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <select name="background" class="w-full pl-14 pr-10 py-4 bg-slate-50/50 border border-slate-200 rounded-[1.25rem] text-[13px] font-bold text-slate-700 focus:ring-4 focus:ring-primary-500/5 focus:border-primary-400 focus:bg-white transition-all outline-none cursor-pointer" style="appearance: none; -webkit-appearance: none; -moz-appearance: none; background-image: none !important;">

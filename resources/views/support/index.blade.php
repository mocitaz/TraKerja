            ...
            <div x-show="activeTab === 'history'" class="max-w-3xl mx-auto space-y-4 slide-fade-enter" style="display:none;" x-cloak>
                ...
                @empty
                    <div class="bg-white border border-zinc-200/60 rounded-xl p-12 text-center flex flex-col items-center justify-center border-dashed shadow-3xs">
                        ...
                        <p class="text-[10px] text-zinc-500 font-semibold max-w-[280px] leading-relaxed">Need technical help or want to suggest a new feature? Contact our support team by submitting a ticket.</p>
                    </div>
                @endforelse

...
<head>
    ...
    <title>429 - Too Many Requests | TraKerja</title>
...
<body class="font-sans antialiased bg-gray-50">
    <div class="min-h-screen flex items-center justify-center px-4 py-12">
        <div class="max-w-md w-full text-center">
            <!-- Error Code -->
            <div class="mb-6">
                <h1 class="text-8xl sm:text-9xl font-bold gradient-text mb-2">429</h1>
            ...
            <!-- Message -->
            <div class="mb-8">
                <h2 class="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">Terlalu Banyak Permintaan</h2>
                <p class="text-gray-600 text-sm sm:text-base leading-relaxed">
                    Anda telah melakukan terlalu banyak permintaan. Silakan tunggu beberapa saat sebelum mencoba lagi.
                </p>
            </div>
            ...
            <div class="mt-8 pt-6 border-t border-gray-200">
                <p class="text-xs text-gray-500">
                    Tunggu beberapa detik sebelum mencoba lagi. Ini membantu menjaga keamanan sistem.
                </p>
            </div>
        </div>
    </div>

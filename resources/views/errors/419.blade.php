...
<head>
    ...
    <title>419 - Page Expired | TraKerja</title>
...
<body class="font-sans antialiased bg-gray-50">
    <div class="min-h-screen flex items-center justify-center px-4 py-12">
        <div class="max-w-md w-full text-center">
            <!-- Error Code -->
            <div class="mb-6">
                <h1 class="text-8xl sm:text-9xl font-bold gradient-text mb-2">419</h1>
                <div class="w-24 h-1 bg-gradient-to-r from-[#d983e4] to-[#4e71c5] mx-auto rounded-full"></div>
            </div>

            <!-- Icon -->
            <div class="mb-6 flex justify-center">
                <div class="w-24 h-24 sm:w-28 sm:h-28 gradient-bg rounded-2xl flex items-center justify-center shadow-lg transform -rotate-12 hover:rotate-0 transition-transform duration-300">
            ...
            <!-- Message -->
            <div class="mb-8">
                <h2 class="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">Sesi Telah Berakhir</h2>
                <p class="text-gray-600 text-sm sm:text-base leading-relaxed">
                    Halaman ini telah kedaluwarsa karena tidak ada aktivitas dalam waktu lama. Silakan coba lagi.
                </p>
            </div>
            ...
            <div class="mt-8 pt-6 border-t border-gray-200">
                <p class="text-xs text-gray-500">
                    Tips: Pastikan Anda tidak meninggalkan halaman terlalu lama saat mengisi formulir.
                </p>
            </div>
        </div>
    </div>

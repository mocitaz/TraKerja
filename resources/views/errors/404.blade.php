    ...
    <div class="min-h-screen flex items-center justify-center px-4 py-12">
        <div class="max-w-md w-full text-center">
            ...
            <div class="mb-6 flex justify-center">
                <div
                    class="w-24 h-24 sm:w-28 sm:h-28 gradient-bg rounded-2xl flex items-center justify-center shadow-lg transform rotate-6 hover:rotate-0 transition-transform duration-300">
            ...
            <div class="mt-8 pt-6 border-t border-gray-200">
                <p class="text-xs text-gray-500">
                    Jika Anda yakin ini adalah kesalahan, silakan <a href="mailto:trakerja@teknalogi.id"
                        class="text-[#d983e4] hover:text-[#4e71c5] font-medium">hubungi support</a>
                </p>
            </div>
        </div>
    </div>

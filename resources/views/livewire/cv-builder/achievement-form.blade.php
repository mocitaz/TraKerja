            ...
            @foreach($achievements as $achievement)
                <div class="bg-white border border-slate-200/60 rounded-3xl p-5 hover:border-indigo-600/30 transition-all group flex flex-col md:flex-row md:items-center justify-between gap-6">
                    ...
                    <div class="flex items-center gap-2 md:opacity-0 group-hover:opacity-100 transition-all">
                        <button wire:click="edit({{ $achievement->id }})" class="w-10 h-10 flex items-center justify-center bg-indigo-50 text-indigo-600 rounded-xl hover:bg-indigo-600 hover:text-white transition-all">
                ...
                <form wire:submit.prevent="save" class="p-6">
                    <div class="space-y-4">
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" wire:model="title" class="w-full pl-9 pr-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-700 focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-400 transition-all" placeholder="e.g. Employee of the Month, Hackathon Winner">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" wire:model="issuer" class="w-full pl-9 pr-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-700 focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-400 transition-all" placeholder="e.g. Google, XYZ University">
                        ...
                        <div>
                            ...
                            <input type="date" wire:model="date" class="w-full px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-700 focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-400 transition-all">
                        ...
                        <div>
                            ...
                            <textarea wire:model="description" rows="3" class="w-full px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-700 focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-400 transition-all leading-relaxed" placeholder="Tell us more about this achievement..."></textarea>
                        </div>
                    </div>

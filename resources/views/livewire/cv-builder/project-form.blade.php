            ...
            @foreach($projects as $project)
                <div class="bg-white border border-slate-200/60 rounded-3xl p-5 hover:border-indigo-600/30 transition-all group flex flex-col md:flex-row md:items-center justify-between gap-6">
                        ...
                        <div class="min-w-0">
                            ...
                            <div class="flex flex-wrap items-center gap-x-3 gap-y-1">
                                ...
                                @if($project->project_url)
                                    <a href="{{ $project->project_url }}" target="_blank" class="text-[10px] font-black text-indigo-600 uppercase tracking-widest flex items-center gap-1 hover:underline">
                    ...
                    <div class="flex items-center gap-2 md:opacity-0 group-hover:opacity-100 transition-all">
                        <button wire:click="edit({{ $project->id }})" class="w-10 h-10 flex items-center justify-center bg-indigo-50 text-indigo-600 rounded-xl hover:bg-indigo-600 hover:text-white transition-all">
                ...
                <form wire:submit.prevent="save" class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="md:col-span-2">
                            ...
                            <div class="relative">
                                <input type="text" wire:model="project_name" class="w-full pl-9 pr-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-700 focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-400 transition-all" placeholder="e.g. E-commerce Platform, Mobile App">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="relative">
                                <input type="text" wire:model="role" class="w-full pl-9 pr-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-700 focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-400 transition-all" placeholder="e.g. Full Stack Developer, UI Designer">
                        ...
                        <div>
                            ...
                            <input type="date" wire:model="end_date" :disabled="$wire.is_ongoing" class="w-full px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-700 focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-400 transition-all disabled:opacity-40">
                        </div>
                        <div class="md:col-span-2">
                            <label class="flex items-center gap-2.5 p-3 bg-indigo-50/60 border border-indigo-100 rounded-xl cursor-pointer hover:bg-indigo-50 transition-all">
                                <input type="checkbox" wire:model="is_ongoing" class="w-4 h-4 rounded text-indigo-600 focus:ring-indigo-500 border-slate-300">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="relative">
                                <input type="url" wire:model="project_url" class="w-full pl-9 pr-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-700 focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-400 transition-all" placeholder="https://github.com/...">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" wire:model="technologies" class="w-full px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-700 focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-400 transition-all" placeholder="e.g. React, Node.js, Tailwind CSS">
                        </div>
                        <div class="md:col-span-2">
                            <label class="block text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1.5">Description (Optional)</label>
                            <textarea wire:model="description" rows="3" class="w-full px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-700 focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-400 transition-all leading-relaxed" placeholder="Describe the project goals and your contributions..."></textarea>
                        </div>
                    </div>

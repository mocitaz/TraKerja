                ...
                <div class="flex flex-col bg-zinc-50/40 rounded-lg p-3 border border-zinc-200/50"
                    ...
                    <div class="space-y-2.5 min-h-[200px]">
                        ...
                        <div wire:loading.remove class="space-y-2.5">
                            ...
                            @empty
                            <div class="flex flex-col items-center justify-center py-8 bg-white/40 rounded border border-dashed border-zinc-200/50">
                                <div class="w-8 h-8 bg-zinc-100/50 rounded flex items-center justify-center text-zinc-350 mb-2">
                                    <i class="ph ph-folder-open text-base"></i>
                                </div>
                                <span class="text-[9px] font-semibold text-zinc-400 italic">No Applications</span>
                            </div>
                            @endforelse

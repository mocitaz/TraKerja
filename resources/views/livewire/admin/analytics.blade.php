                ...
                <div class="px-6 py-4 border-b border-gray-200">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Distribusi status lamaran</p>
                        </div>
                    </div>
                </div>
                <div class="p-6">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900">Applications By Platform</h3>
                            <p class="text-sm text-gray-500">Platform paling populer</p>
                        </div>
                    </div>
                </div>
                <div class="p-6">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900">Premium vs Free Users</h3>
                            <p class="text-sm text-gray-500">Distribusi user premium dan free</p>
                        </div>
                    </div>
                </div>
                <div class="p-6">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900">Goals Achievement</h3>
                            <p class="text-sm text-gray-500">Goal yang dicapai vs pending</p>
                        </div>
                    </div>
                </div>
                <div class="p-6">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900">Verified vs Unverified Users</h3>
                            <p class="text-sm text-gray-500">Perbandingan user terverifikasi dan tidak terverifikasi</p>
                        </div>
                    </div>
                </div>
                <div class="p-6">
            ...
            <div class="px-6 py-4 border-b border-gray-200">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Statistik lengkap dalam {{ $stats['periodDays'] }} hari terakhir</p>
                    </div>
                </div>
            </div>
            <div class="p-6">

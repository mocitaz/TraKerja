    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <a href="{{ route('admin.settings') }}" class="group bg-white rounded-xl p-4 shadow hover:shadow-lg transition-all duration-300 hover:scale-105 border-2 border-transparent hover:border-emerald-200">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-xs text-gray-500 font-medium">Configure</p>

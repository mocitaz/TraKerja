<x-admin-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-primary-900">Premium Pricing & Plans</h2>
                    <p class="text-sm text-primary-600">Configure premium subscription pricing and benefits</p>
                </div>
            </div>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="p-6 rounded-xl shadow-md {{ $monetizationEnabled ? 'bg-gradient-to-r from-purple-500 to-purple-700' : 'bg-gradient-to-r from-emerald-500 to-emerald-700' }}">
            <div class="flex items-center justify-between text-white">
                <div>
                    <p class="text-sm font-medium opacity-90">Monetization Status</p>
                ...
                <a href="{{ route('admin.index') }}" class="px-4 py-2 bg-white/20 hover:bg-white/30 rounded-lg transition-colors font-semibold">
                    Go to Dashboard →
                </a>
            </div>
        </div>

<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center space-x-3 sm:space-x-4">
            <div
                class="w-8 h-8 sm:w-10 sm:h-10 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center shadow-lg border border-white/30">
            ...
            <div>
                <h2
                    class="text-lg sm:text-2xl font-bold bg-gradient-to-r from-[#d983e4] via-purple-600 to-[#4e71c5] bg-clip-text text-transparent">
                    Pembayaran Gagal
                </h2>

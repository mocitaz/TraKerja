            ...
            <div class="w-full max-w-md">
                ...
                <div class="grid grid-cols-2 gap-3 mb-2">
                    ...
                    <a href="{{ route('auth.google') }}"
                        ...
                        <span class="group-hover:text-gray-900 transition-colors duration-200 truncate">
                            Google
                        </span>
                    </a>
                    ...
                    <a href="{{ route('auth.linkedin') }}"
                        ...
                        <span class="group-hover:text-[#0077B5] transition-colors duration-200 truncate">
                            LinkedIn
                        </span>
                    </a>
                </div>

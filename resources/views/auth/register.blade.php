    ...
    <div class="min-h-screen bg-white font-sans antialiased text-[#37352f] flex flex-col items-center pt-16 pb-6 px-6 selection:bg-[#2383e2]/10">
        ...
        <div class="w-full max-w-[340px] flex-1 flex flex-col justify-center items-center space-y-6">
            ...
            <div class="flex flex-col items-center text-center">
                ...
                <p class="text-sm text-slate-400 font-normal mt-0.5">Free forever. No credit card required.</p>
            </div>

            <!-- Validation Errors Alert Summary -->
            <div class="w-full">
                @if ($errors->any())
                    <div class="mb-4 p-3.5 bg-rose-50/70 border border-rose-200/80 rounded-md text-rose-900 text-xs font-semibold flex items-start gap-2.5 shadow-3xs text-left">
            ...
            <!-- Form -->
            <form method="POST" action="{{ route('register') }}" class="w-full space-y-4 text-left">
                @csrf

                <!-- Name Field -->
                <div>
                    <label for="name" class="block text-[11px] font-medium text-slate-550 mb-1.5">Full Name</label>
                ...
                <!-- Password Field -->
                <div>
                    <label for="password" class="block text-[11px] font-medium text-slate-555 mb-1.5">Password</label>
                    <div class="relative">
                ...
                <div>
                    <label for="password_confirmation" class="block text-[11px] font-medium text-slate-555 mb-1.5">Confirm Password</label>
                    <div class="relative">
                ...
                <!-- Submit Button -->
                <button type="submit" id="register-submit-btn" class="w-full py-2 bg-[#2383e2] hover:bg-[#1c72cb] active:bg-[#1560b3] text-white rounded-md text-xs font-bold transition-colors shadow-3xs flex items-center justify-center gap-2 active:scale-98 focus:outline-none mt-2 cursor-pointer">
            ...
            <div class="relative w-full my-4">
                ...
                <div class="relative flex justify-center text-[10px] font-medium text-slate-450">
            ...
            <div class="grid grid-cols-2 gap-3 w-full">
                <!-- Google Card -->
                <a href="{{ route('auth.google') }}" class="flex flex-col items-center justify-center py-3.5 px-3 bg-white hover:bg-slate-50 border border-slate-200/80 rounded-md transition-colors shadow-3xs active:scale-98 cursor-pointer space-y-1">
                    ...
                    <span class="text-[10px] font-bold text-slate-700">Google</span>
                </a>

                <!-- LinkedIn Card -->
                <a href="{{ route('auth.linkedin') }}" class="flex flex-col items-center justify-center py-3.5 px-3 bg-white hover:bg-slate-50 border border-slate-200/80 rounded-md transition-colors shadow-3xs active:scale-98 cursor-pointer space-y-1">
                    <svg class="w-5 h-5 shrink-0" viewBox="0 0 24 24" fill="#0077B5">
                        <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                    </svg>
                    <span class="text-[10px] font-bold text-slate-700">LinkedIn</span>
                </a>
            </div>

            <!-- Sign In Footer link -->
            <div class="text-xs font-normal text-slate-500 pt-2">

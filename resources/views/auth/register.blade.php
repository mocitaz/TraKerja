    ...
    <div class="min-h-screen bg-white font-sans antialiased text-[#37352f] flex flex-col items-center pt-12 pb-6 px-4 selection:bg-[#2383e2]/10">
        ...
        <div class="w-full max-w-[320px] flex-1 flex flex-col justify-center items-center space-y-5">
            ...
            <div class="flex flex-col items-center text-center">
                ...
                <p class="text-xs text-slate-450 font-normal mt-1">Free forever. No credit card required.</p>
            </div>

            <!-- Validation Errors Alert Summary -->
            <div class="w-full">
                @if ($errors->any())
                    <div class="mb-4 p-3 bg-rose-50/50 border border-rose-200/80 rounded-md text-rose-955 text-xs font-semibold flex items-start gap-2 text-left">
            ...
            <!-- Form -->
            <form method="POST" action="{{ route('register') }}" class="w-full space-y-3.5 text-left">
                @csrf

                <!-- Name Field -->
                <div>
                    <label for="name" class="block text-[10.5px] font-medium text-slate-500 mb-1">Full Name</label>
                ...
                <!-- Password Field -->
                <div>
                    <label for="password" class="block text-[10.5px] font-medium text-slate-500 mb-1">Password</label>
                    <div class="relative">
                ...
                <!-- Submit Button -->
                <button type="submit" id="register-submit-btn" class="w-full py-1.5 bg-[#2383e2] hover:bg-[#1c72cb] active:bg-[#1560b3] text-white rounded-md text-xs font-bold transition-colors shadow-3xs flex items-center justify-center gap-2 active:scale-98 focus:outline-none mt-2 cursor-pointer">
            ...
            <div class="grid grid-cols-2 gap-2.5 w-full">
                <!-- Google Card -->
                <a href="{{ route('auth.google') }}" class="flex flex-col items-center justify-center py-2.5 px-3 bg-white hover:bg-slate-50 border border-slate-200/80 rounded-md transition-colors shadow-3xs active:scale-98 cursor-pointer space-y-0.5">
                    ...
                    <span class="text-[9.5px] font-bold text-slate-600">Google</span>
                </a>

                <!-- LinkedIn Card -->
                <a href="{{ route('auth.linkedin') }}" class="flex flex-col items-center justify-center py-2.5 px-3 bg-white hover:bg-slate-50 border border-slate-200/80 rounded-md transition-colors shadow-3xs active:scale-98 cursor-pointer space-y-0.5">
                    <svg class="w-4.5 h-4.5 shrink-0" viewBox="0 0 24 24" fill="#0077B5">

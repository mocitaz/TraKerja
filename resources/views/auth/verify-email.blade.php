    ...
    <div class="min-h-screen bg-white font-sans antialiased text-[#37352f] flex flex-col justify-center items-center py-12 px-4 selection:bg-[#2383e2]/10">
        ...
        <div class="w-full max-w-[320px] flex flex-col items-center">
            ...
            @if (session('status') == 'verification-link-sent')
                <div class="w-full mb-3 p-3 bg-emerald-50/60 border border-emerald-200/80 rounded-md text-emerald-900 text-xs font-semibold flex items-start gap-2 shadow-3xs text-left">
            ...
            <!-- Target Email Box -->
            <div class="w-full bg-[#fcfcfc] border border-slate-200/80 rounded-lg p-3 text-left mb-3">
            ...
            <div class="w-full bg-[#fcfcfc] border border-slate-200/80 rounded-lg p-4 space-y-3 text-left mb-3">
            ...
            <!-- Resend Action Form -->
            <form method="POST" action="{{ route('verification.send') }}" class="w-full mb-2">
                @csrf

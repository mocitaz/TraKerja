    ...
    <div class="min-h-screen bg-white font-sans antialiased text-[#37352f] flex flex-col items-center pt-16 pb-6 px-6 selection:bg-[#2383e2]/10">
        ...
        <div class="w-full max-w-[340px] flex-1 flex flex-col justify-center items-center space-y-6">
            ...
            <div class="flex flex-col items-center text-center">
                ...
                <p class="text-sm text-slate-400 font-normal mt-0.5">Please check your inbox to continue</p>
            </div>
            ...
            <form method="POST" action="{{ route('verification.send') }}" class="w-full">
                @csrf
                <button type="submit" class="w-full py-2 bg-[#2383e2] hover:bg-[#1c72cb] active:bg-[#1560b3] text-white rounded-md text-xs font-bold transition-colors shadow-3xs flex items-center justify-center gap-2 active:scale-98 focus:outline-none cursor-pointer">

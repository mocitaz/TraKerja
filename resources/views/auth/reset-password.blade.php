    ...
    <div class="min-h-screen bg-white font-sans antialiased text-[#37352f] flex flex-col items-center pt-16 pb-6 px-6 selection:bg-[#2383e2]/10">
        ...
        <div class="w-full max-w-[340px] flex-1 flex flex-col justify-center items-center space-y-6">
            ...
            <div class="flex flex-col items-center text-center">
                ...
                <p class="text-sm text-slate-400 font-normal mt-0.5">Enter your new password details</p>
            </div>

            <!-- Form -->
            <form method="POST" action="{{ route('password.store') }}" class="w-full space-y-4 text-left">
                @csrf
                ...
                <!-- Password Field -->
                <div>
                    <label for="password" class="block text-[11px] font-medium text-slate-555 mb-1.5">New Password</label>
                    <div class="relative">

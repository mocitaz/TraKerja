    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/20 flex">
        ...
        <div class="hidden lg:flex lg:w-1/2 gradient-animated relative overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col justify-center p-8 xl:p-12 text-white">
                    ...
                    <div class="flex items-center space-x-4 mb-4">
                        ...
                        <div class="flex-1">
                            <div class="flex items-center space-x-3 mb-1.5">
                                ...
                                <div class="flex items-center px-2.5 py-1 rounded-md bg-white/15 backdrop-blur-sm border border-white/25 hover:bg-white/20 hover:border-white/35 transition-all duration-300 group">
                ...
                <div class="mb-6">
                    <h2 class="text-3xl xl:text-4xl font-bold mb-2 drop-shadow-lg">Reset Password</h2>
                    <p class="text-white/85 text-base xl:text-lg leading-relaxed">Create a new secure password for your account</p>
                </div>
                ...
                <div class="space-y-3">
                    <div class="flex items-start space-x-3 group p-3 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 transition-all duration-300 cursor-pointer">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-white font-semibold text-base mb-0.5">Secure Reset Process</h3>
                            <p class="text-white/75 text-sm leading-snug">Your password reset is encrypted and secure</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-3 group p-3 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 transition-all duration-300 cursor-pointer">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-white font-semibold text-base mb-0.5">Strong Password Requirements</h3>
                            <p class="text-white/75 text-sm leading-snug">Must include letters, numbers, and symbols</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-3 group p-3 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 transition-all duration-300 cursor-pointer">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-white font-semibold text-base mb-0.5">Real-time Validation</h3>
                            <p class="text-white/75 text-sm leading-snug">Instant feedback on password strength</p>
                        </div>
                    </div>
                </div>
            </div>

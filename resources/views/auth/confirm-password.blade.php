    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/20 flex">
        ...
        <div class="hidden lg:flex lg:w-1/2 gradient-animated relative overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col justify-center p-8 xl:p-12 text-white">
                ...
                <div class="mb-6">
                    <h2 class="text-3xl xl:text-4xl font-bold mb-2 drop-shadow-lg">Confirm Password</h2>
                    <p class="text-white/85 text-base xl:text-lg leading-relaxed">Please confirm your password before continuing</p>
                </div>
                ...
                <div class="space-y-3">
                    <div class="flex items-start space-x-3 group p-3 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 transition-all duration-300 cursor-pointer">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-white font-semibold text-base mb-0.5">Secure Verification</h3>
                            <p class="text-white/75 text-sm leading-snug">Protect sensitive actions with password confirmation</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-3 group p-3 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 transition-all duration-300 cursor-pointer">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-white font-semibold text-base mb-0.5">Quick Process</h3>
                            <p class="text-white/75 text-sm leading-snug">Fast and secure verification process</p>
                        </div>
                    </div>
                </div>
            </div>

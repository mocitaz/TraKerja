    ...
    <div class="min-h-screen bg-white font-sans antialiased text-[#37352f] flex flex-col items-center pt-12 pb-6 px-4 selection:bg-[#2383e2]/10">
        ...
        <div class="w-full max-w-[320px] flex-1 flex flex-col justify-center items-center space-y-5">
            ...
            <div class="flex flex-col items-center text-center">
                ...
                <p class="text-xs text-slate-450 font-normal mt-1">Log in to your TraKerja account</p>
            </div>

            <!-- Status Alerts -->
            <div class="w-full">
                @if (session('status') === 'registration-successful' || session('status') === 'verification-link-sent')
                    <div class="mb-4 p-3 bg-amber-50/50 border border-amber-200/80 rounded-md text-amber-955 text-xs font-semibold flex items-start gap-2 text-left">
            ...
            <!-- Form -->
            <form method="POST" action="{{ route('login') }}" class="w-full space-y-3.5 text-left">
                @csrf

            ...
            <div class="w-full max-w-md">
                ...
                <div class="glass-morphism rounded-3xl p-8 transform transition-all duration-500 hover:shadow-2xl">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        class="flex items-center justify-center gap-2 py-3 px-3
                                border border-gray-300 rounded-lg bg-white text-gray-700 font-semibold text-sm
                            ...
                            <span class="group-hover:text-gray-900 transition-colors duration-200 truncate">Google</span>
                        </a>
                        ...
                        class="flex items-center justify-center gap-2 py-3 px-3
                                border border-gray-300 rounded-lg bg-white text-gray-700 font-semibold text-sm
                                hover:bg-[#0077B5]/5 hover:border-[#0077B5] hover:shadow-md
                                active:scale-[0.98] transition-all duration-200 group">
                            {{-- LinkedIn Logo SVG --}}
                            ...
                            <span class="group-hover:text-[#0077B5] transition-colors duration-200 truncate">LinkedIn</span>
                        </a>
                    </div>

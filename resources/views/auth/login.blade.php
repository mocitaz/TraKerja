    ...
    <div class="min-h-screen bg-white font-sans antialiased text-[#37352f] flex flex-col justify-between items-center py-16 px-6 selection:bg-[#2383e2]/10">
        ...
        <div class="w-full max-w-[340px] mx-auto my-auto flex flex-col items-center space-y-6">
            ...
            <div class="grid grid-cols-2 gap-2.5 w-full">
                <a href="{{ route('auth.google') }}" class="flex items-center justify-center gap-2.5 py-2 px-3 bg-white hover:bg-slate-50 border border-slate-200 rounded-md text-xs font-semibold text-slate-700 transition-colors shadow-3xs active:scale-98 cursor-pointer">
                ...
                <a href="{{ route('auth.linkedin') }}" class="flex items-center justify-center gap-2.5 py-2 px-3 bg-white hover:bg-slate-50 border border-slate-200 rounded-md text-xs font-semibold text-slate-700 transition-colors shadow-3xs active:scale-98 cursor-pointer">

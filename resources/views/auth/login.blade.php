        ...
        <div class="hidden lg:flex lg:col-span-6 xl:col-span-7 bg-zinc-950 border-r border-zinc-800/80 text-white relative flex-col justify-between p-8 lg:p-12 overflow-hidden select-none">
            ...
            <div class="relative z-10 my-auto py-12 max-w-xl">
                <div class="space-y-6">
                    ...
                    <p class="text-sm text-zinc-400 leading-relaxed font-normal max-w-md">
                        TraKerja membantu pencari kerja mengorganisasi lamaran pekerjaan, mengoptimalkan CV untuk sistem ATS, dan mempersiapkan wawancara kerja dalam satu platform terintegrasi.
                    </p>

                    <!-- Clean Tool Features Grid -->
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-8 border-t border-zinc-900/60 mt-8">
                        <div class="flex items-start gap-3">
                            <div class="w-8 h-8 rounded-lg bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-300 shrink-0">
                                <i class="ph ph-kanban text-base text-primary-400"></i>
                            </div>
                            <div>
                                <h4 class="text-xs font-bold text-zinc-200">Centralized Tracking</h4>
                                <p class="text-[10px] text-zinc-550 mt-1 leading-normal">Kelola dan pantau seluruh status lamaran Anda dalam satu papan Kanban terpadu.</p>
                            </div>
                        </div>

                        <div class="flex items-start gap-3">
                            <div class="w-8 h-8 rounded-lg bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-300 shrink-0">
                                <i class="ph ph-file-text text-base text-primary-400"></i>
                            </div>
                            <div>
                                <h4 class="text-xs font-bold text-zinc-200">AI Resume Optimizer</h4>
                                <p class="text-[10px] text-zinc-550 mt-1 leading-normal">Analisis kelayakan CV PDF Anda menggunakan algoritma parser pintar.</p>
                            </div>
                        </div>

                        <div class="flex items-start gap-3">
                            <div class="w-8 h-8 rounded-lg bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-300 shrink-0">
                                <i class="ph ph-chat-circle text-base text-primary-400"></i>
                            </div>
                            <div>
                                <h4 class="text-xs font-bold text-zinc-200">Mock Interviews</h4>
                                <p class="text-[10px] text-zinc-550 mt-1 leading-normal">Latih kesiapan menjawab pertanyaan dengan evaluasi kecerdasan buatan.</p>
                            </div>
                        </div>

                        <div class="flex items-start gap-3">
                            <div class="w-8 h-8 rounded-lg bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-300 shrink-0">
                                <i class="ph ph-chart-line text-base text-primary-400"></i>
                            </div>
                            <div>
                                <h4 class="text-xs font-bold text-zinc-200">Salary Benchmarks</h4>
                                <p class="text-[10px] text-zinc-550 mt-1 leading-normal">Bandingkan gaji kompetitif sesuai standar data wilayah UMK terbaru.</p>
                            </div>
                        </div>
                    </div>
                </div>

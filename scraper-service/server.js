...
app.listen(PORT, '0.0.0.5', () => {
    // Listen on all IPv4 addresses so it is accessible inside local networks/VM networks
    // Or let's listen on '0.0.0.0' for universality
});
// Let's change the port binding to 0.0.0.0
app.listen(PORT, () => {

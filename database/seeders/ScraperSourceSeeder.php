        ...
        ScraperSource::updateOrCreate(
            ...
            [
                ...
                'selectors_config' => [
                    ...
                    'location' => '.job-search-card__location, .topcard__flavor-row span.topcard__flavor--bullet, .top-card-layout__first-subline',
                ],
        ...
        ScraperSource::updateOrCreate(
            ...
            [
                ...
                'selectors_config' => [
                    ...
                    'location' => 'span[data-automation="job-detail-location"], span[data-automation="job-location"]',
                ],
                'frequency_minutes' => 360,
